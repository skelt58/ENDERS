				...
				<table class="table_line_outline">
					...
					<tr>
						...
						<td class="td_body">
							...
							<input type='hidden' id="charset"         name='charset'         value='<c:out value='${userInfo.charset}'/>'>
							<!-- 초기화에 사용 -->
							...
							<input type='hidden' id="bsCharset"       name='bsCharset'       value='<c:out value='${userInfo.charset}'/>'>
							<!-- 초기화에 사용 -->
							<!-- 옵션 -->
						</td>
